...
La lógica de Groq está en `server/generateGame.js`. `worker.js` adapta las peticiones de Cloudflare; `api/sendPrompt.js` conserva la compatibilidad con Vercel durante la transición. Las cantidades admitidas coinciden con la interfaz: 1–5 equipos y 1–25 roles. El tema admite hasta 2000 caracteres. 
